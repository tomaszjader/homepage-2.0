...
var TranslateFakeLoader = class extends TranslateLoader {
  getTranslation(lang) {
    return of({});
  }
};
TranslateFakeLoader.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function TranslateFakeLoader_Factory(__ngFactoryType__) {
    return (ɵTranslateFakeLoader_BaseFactory || (ɵTranslateFakeLoader_BaseFactory = ɵɵgetInheritedFactory(TranslateFakeLoader)))(__ngFactoryType__ || TranslateFakeLoader);
  };
})();
TranslateFakeLoader.ɵprov = ɵɵdefineInjectable({
...
var FakeMissingTranslationHandler = class {
  handle(params) {
    return params.key;
  }
};
...
FakeMissingTranslationHandler.ɵprov = ɵɵdefineInjectable({
...
var TranslateDefaultParser = class extends TranslateParser {
  constructor() {
    super(...arguments);
...
TranslateDefaultParser.ɵprov = ɵɵdefineInjectable({
...
var TranslateFakeCompiler = class extends TranslateCompiler {
  compile(value, lang) {
    return value;
  }
...
TranslateFakeCompiler.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function TranslateFakeCompiler_Factory(__ngFactoryType__) {
    return (ɵTranslateFakeCompiler_BaseFactory || (ɵTranslateFakeCompiler_BaseFactory = ɵɵgetInheritedFactory(TranslateFakeCompiler)))(__ngFactoryType__ || TranslateFakeCompiler);
  };
})();
TranslateFakeCompiler.ɵprov = ɵɵdefineInjectable({
...
TranslateService.ɵfac = function TranslateService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TranslateService)(ɵɵinject(TranslateStore), ɵɵinject(TranslateLoader), ɵɵinject(TranslateCompiler), ɵɵinject(TranslateParser), ɵɵinject(MissingTranslationHandler), ɵɵinject(USE_DEFAULT_LANG), ɵɵinject(USE_STORE), ɵɵinject(USE_EXTEND), ɵɵinject(DEFAULT_LANGUAGE));
};
TranslateService.ɵprov = ɵɵdefineInjectable({
...
TranslateDirective.ɵfac = function TranslateDirective_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TranslateDirective)(ɵɵdirectiveInject(TranslateService), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(ChangeDetectorRef));
};
TranslateDirective.ɵdir = ɵɵdefineDirective({
...
TranslatePipe.ɵfac = function TranslatePipe_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || TranslatePipe)(ɵɵdirectiveInject(TranslateService, 16), ɵɵdirectiveInject(ChangeDetectorRef, 16));
};
TranslatePipe.ɵpipe = ɵɵdefinePipe({
  name: "translate",
  type: TranslatePipe,
  pure: false,
  standalone: false
});
TranslatePipe.ɵprov = ɵɵdefineInjectable({
  token: TranslatePipe,
...
TranslateModule.ɵmod = ɵɵdefineNgModule({
  type: TranslateModule,
  declarations: [TranslatePipe, TranslateDirective],
  exports: [TranslatePipe, TranslateDirective]
});
TranslateModule.ɵinj = ɵɵdefineInjector({});
(() => {
